<template>
  <el-form class="login-container">
    ...
    <el-form-item>
      <el-input type="password" v-model="pwd1" placeholder="确认密码" autocomplete="off"></el-input>
    </el-form-item>
    <el-form-item>
      <el-button type="primary" style="width: 48%;">点击注册</el-button>
      <el-button type="primary" style="width: 48%;" @click="gotoLogin">返回登陆</el-button>
    </el-form-item>
  </el-form>
</template>
